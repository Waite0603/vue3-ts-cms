    ...
    <div class="collapse navbar-collapse w-auto max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">账户管理</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/index/role">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
            >
              <svg
            ...
            <span class="nav-link-text ms-1">角色管理</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">客房管理</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/index/roomType">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
            >
              <svg
            ...
            <span class="nav-link-text ms-1">房型管理</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/index/room">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
            >
              <svg
            ...
            <span class="nav-link-text ms-1">房间管理</span>
          </a>
        </li>
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">客户管理</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/index/liveIn">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
            >
              <svg
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">设置</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/index/mine">
            ...
            <span class="nav-link-text ms-1">个人中心</span>
          </a>
        </li>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="/index/mine" class="nav-link text-body font-weight-bold px-0">
